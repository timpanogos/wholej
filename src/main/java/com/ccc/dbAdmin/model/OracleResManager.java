...
public class OracleResManager implements ResManager
{
    OraResPlatformManagerImpl da;
    
    public OracleResManager(OraResPlatformManagerImpl da)
    {
        this.da = da;
    }
    ...
    public void setVersion(DOFObjectID deviceOid, DOFObjectID versionOid, Authentication managerOid) throws SQLException
    {
        ...
        try
        {
            OraDeviceJdbc.setVersion(conn, deviceOid, versionOid, managerOid);
        }
        finally
        {
