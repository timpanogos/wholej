...
{
    public AuthenticationDialog(AsManagerFrame asManager, Component source, PermissionsPanel tablePanel, int index, boolean insert) 
    {
    ...
    static public class AuthNodeRowSelectionPanel extends JPanel implements ActionListener, SwappedFocusListener, AppliedCallback 
    {
        ...
        private final AuthenticationDialog dialog;
        ...
        public AuthNodeRowSelectionPanel(AuthenticationDialog dialog, PermissionsPanel tablePanel, int index, boolean insert)
        {
            this.dialog = dialog;
