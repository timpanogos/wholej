...
public class AncillaryConnectionPanel extends JPanel implements ActionListener, DocumentListener, SwappedFocusListener, WindowFocusListener
{
    ...
    public AncillaryConnectionPanel(DbAdmin dbAdmin)
    {
        ...
        JLabel jdbAncillaryLabel = FrameBase.getLabel("Ancillary:", maxWidth);
        ...
        JLabel jdbAncillaryConnectedLabel = FrameBase.getLabel("Connected:", maxWidth);
        ...
        oracleAncillaryRadio = FrameBase.addRadioButtonToPanel(oracleAncillaryLabel, false, true, width, -1, "Oracle Ancillary Power DB connection", rowPanel, this);
        ...
        associateState(VendorType.Oracle, oracleAncillaryRadio, oracleAncillaryCheck);
        panel.add(rowPanel);
        ...
        rowPanel = new JPanel();
        rowPanel.setLayout(new BoxLayout(rowPanel, BoxLayout.X_AXIS));
        jdbAncillaryRadio = FrameBase.addRadioButtonToPanel(jdbAncillaryLabel, false, true, width, -1, "JavaDB Ancillary Power DB connection", rowPanel, this);
        jdbAncillaryCheck = FrameBase.addCheckBoxToPanel(jdbAncillaryConnectedLabel, false, false, width, -1, "Currently connected", rowPanel);
        associateState(VendorType.JavaDb, jdbAncillaryRadio, jdbAncillaryCheck);
        panel.add(rowPanel);
        
        group.add(jdbAncillaryRadio);
        ...
        rowPanel = new JPanel();
        rowPanel.setLayout(new BoxLayout(rowPanel, BoxLayout.X_AXIS));
        pgAncillaryRadio = FrameBase.addRadioButtonToPanel(pgAncillaryLabel, true, true, width, -1, "Postgres Ancillary Power DB connection", rowPanel, this);
        pgAncillaryCheck = FrameBase.addCheckBoxToPanel(pgAncillaryConnectedLabel, false, false, width, -1, "Currently connected", rowPanel);
        associateState(VendorType.Postgres, pgAncillaryRadio, pgAncillaryCheck);
        panel.add(rowPanel);
    ...
    private void adjustForSelection()
    {
        ...
        if(jdbAncillaryRadio.isSelected())
        {
